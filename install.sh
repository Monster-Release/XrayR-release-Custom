...
install_XrayR() {
    ...
    file="https://github.com/Monster-Release/XrayR-release-Custom/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/Monster-Release/XrayR-release-Custom/master/XrayR.sh
